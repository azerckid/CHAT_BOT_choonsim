...
- 명세: `docs/features/chat/user-context-layers-spec.md` (Section 12)
- 구현 계획: `docs/roadmap/user-context-layers-implementation-plan.md` (Section 12, Phase 10)
- LangGraph·Gemini 연동: `docs/features/chat/interrupt-strategy.md` 등과 함께 참고.
