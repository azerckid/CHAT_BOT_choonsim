...
> Last Updated: 2026-02-08 17:58

**목적**: 프로젝트 규모 확장에 따른 문서 관리 체계화 및 "Vison to Test" 맥락 보존을 위한 5계층 표준 도입.
...
- **Archive**: `docs/archive/` 또는 각 레이어의 `00_ARCHIVE/`로 이동된 과거 기록. 완료된 태스크나 폐기된 설계.

---

## Related Documents
- **Foundation**: [Roadmap](./05_ROADMAP.md) - 프로젝트 전체 일정 및 실행 전략
- **Logic**: [Backlog](../04_Logic/00_BACKLOG.md) - 현재 진행 중인 구현 작업 리스트
- **Foundation**: [Document Consolidation](./10_DOCUMENT_CONSOLIDATION_STRATEGY.md) - 문서 통합 및 정리 전략
