...
**현재 문서**:
1. `docs/reports/CHOCO_RE_DENOMINATION_VERIFICATION.md`
   - 목적: 플랜 검증 보고서 (구현 전)
   - 상태: ⚠️ 부분 구현 완료 (수정 필요 사항 다수 발견)

2. `docs/reports/CHOCO_RE_DENOMINATION_IMPLEMENTATION_VERIFICATION.md`
...
**현재 문서**:
1. `docs/reports/verification/NEAR_CHAT_BALANCE_UI_VERIFICATION.md`
   - 목적: 초기 검증 보고서

2. `docs/reports/verification/NEAR_CHAT_BALANCE_UI_IMPLEMENTATION_VERIFICATION.md`
   - 목적: 구현 완료 검증 보고서

3. `docs/reports/NEAR_CHAT_BALANCE_UI_COMPLETION.md`
   - 목적: 완료 보고서
...
**현재 문서**:
1. `docs/reports/verification/NEAR_UX_GAP_ANALYSIS_VERIFICATION.md`
2. `docs/reports/verification/NEAR_UX_IMPROVEMENTS_VERIFICATION.md`
3. `docs/reports/verification/NEAR_UX_IMPLEMENTATION_VERIFICATION.md`
4. `docs/reports/NEAR_UX_GAP_ANALYSIS.md` (분석 보고서)
...
**현재 문서**:
1. `docs/reports/verification/PHASE_1_2_VERIFICATION.md`
2. `docs/reports/verification/PHASE_3_VERIFICATION.md`
3. `docs/reports/verification/PHASE_3_UPDATE_VERIFICATION.md`
4. `docs/reports/verification/PHASE_4_VERIFICATION.md`
5. `docs/reports/verification/PHASE_5_VERIFICATION.md`
...
**현재 문서**:
1. `docs/reports/VERCEL_AI_SDK_ADOPTION_RECOMMENDATION.md`
   - 목적: 도입 권장 사항

2. `docs/reports/VERCEL_AI_SDK_ADOPTION_VERIFICATION.md`
   - 목적: 문서 검증 보고서

3. `docs/roadmap/VERCEL_AI_SDK_ADOPTION.md`
   - 목적: 도입 계획 (roadmap)
...
**현재 문서**:
1. `docs/reports/DOCUMENT_STRUCTURE_VERIFICATION.md`
   - 목적: 문서 구조 검증

2. `docs/reports/FILENAME_CONSISTENCY_PLAN.md`
   - 목적: 파일명 일관성 계획

3. `docs/reports/PLANS_VS_ROADMAP_ANALYSIS.md`
...
title: [통합 문서 제목]
consolidated_from:
  - "docs/reports/ORIGINAL_1.md"
  - "docs/reports/ORIGINAL_2.md"
...
**원본 문서**: `docs/reports/ORIGINAL_1.md` (아카이브됨)
...
**원본 문서**: `docs/reports/ORIGINAL_2.md` (아카이브됨)
...
2. 원본 문서 헤더에 통합 정보 추가:
   ...
   status: archived
   archived_reason: "통합됨"
   consolidated_into: "docs/reports/NEW_CONSOLIDATED.md"
