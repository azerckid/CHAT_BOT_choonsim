...
INSERT INTO _prisma_migrations VALUES('b1d7e312-d8fb-47e8-93f1-e2fdadbef084','28fb29d99e54871186cde70d77938734412026e3eea8d315b259e2b4b4379b27',1767645759361,'20260105204239_add_character_emotion',NULL,NULL,1767645759359,1);
...
CREATE TABLE IF NOT EXISTS "CharacterStat" (
    ...
    "lastGiftAt" DATETIME,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL, "currentEmotion" TEXT DEFAULT 'JOY', "emotionExpiresAt" DATETIME,
